...
def _trader_worker(
    ...
    try:
        ...
        try:
            trader.leverage_multiplier = float(leverage_multiplier) if leverage_multiplier is not None else 1.0
            if trader.leverage_multiplier <= 0:
                trader.leverage_multiplier = 1.0
        except (TypeError, ValueError):
            trader.leverage_multiplier = 1.0
